  ...
  with UniQuery1 do
    begin
      ...
      try
        ...
        ShowMessage('Armário já ocupado!');
        Edit1.SetFocus;
        end;
    end;
  UniQuery2.Refresh;
...
begin
  with UniQuery1 do
  If MessageBox(Handle, 'Deseja limpar todos os armários?', 'Favor confirmar...', MB_YESNO+MB_SYSTEMMODAL+MB_ICONQUESTION+MB_DEFBUTTON1) = ID_YES Then
      begin
...
begin
  with UniQuery1 do
    If MessageBox(Handle, 'Deseja limpar este armário?', 'Limpar Armário', MB_YESNO+MB_SYSTEMMODAL+MB_ICONQUESTION+MB_DEFBUTTON1) = ID_YES Then
      begin
...
begin
  Label9.Caption := 'Armário 6';
end;

procedure TForm3.Label11MouseLeave(Sender: TObject);
begin
  Label11.Caption := 'Armário 8';
end;
